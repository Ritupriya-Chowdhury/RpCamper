...
const Products = () => {
  ...
  return (
    <div className={` flex flex-col lg:flex-row p-4 pt-32 ${theme==='dark'?'bg-gray-500':'bg-gray-200'}`}>
      ...
      <div className={`filters ${isFilterMenuOpen ? 'block' : 'hidden'} lg:block mb-6 ml-4`}>
