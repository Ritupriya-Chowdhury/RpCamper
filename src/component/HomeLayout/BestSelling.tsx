...
const BestSellingProducts = () => {
  ...
  return (
    <div className={`best-selling-products-section py-8 px-4 ${theme==='dark'?"bg-gray-600":""}`}>
      <h2 className={`text-2xl font-bold text-center mb-6 ${theme==='dark'?"text-sky-300":"text-sky-600"}`}>Best Selling Products</h2>
      <Swiper
        modules={[Scrollbar]}
      ...
      >
        <SwiperSlide >
          <div className={`product-card px-4 pt-16 pb-4  bg-white rounded-lg shadow-md ${theme==='dark'?" ":""}`}>
            <img src={pic1} alt="tent" className="w-64 h-48  object-cover mb-8 mx-auto rounded-lg" />
            <h3 className="text-xl font-semibold">Camping Tent</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className={`product-card p-4  bg-white rounded-lg shadow-md ${theme==='dark'?" ":" "}`}>
            <img src={pic2} alt="bag" className="w-64 h-64 object-cover mb-4  mx-auto  rounded-lg" />
            <h3 className="text-xl font-semibold">Camping Bag</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className={`product-card p-4  bg-white rounded-lg shadow-md ${theme==='dark'?" ":" "}`}>
            <img src={pic3} alt="pillow" className="w-64 h-64 object-cover mb-4  mx-auto  rounded-lg" />
            <h3 className="text-xl font-semibold">Camping Pillow</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className={`product-card p-4  bg-white rounded-lg shadow-md ${theme==='dark'?" ":" "}`}>
            <img src={pic4} alt="Sleeping Bag" className="w-64 h-64 object-cover mb-4 mx-auto  rounded-lg" />
            <h3 className="text-xl font-semibold">Camping Sleeping Bag</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className={`product-card p-4  bg-white rounded-lg shadow-md ${theme==='dark'?" ":" "}`}>
            <img src={pic5} alt="Jacket" className="w-64 h-64 object-cover mb-4  mx-auto  rounded-lg" />
            <h3 className="text-xl font-semibold">Weather-Resistant Jacket</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className={`product-card p-4  bg-white rounded-lg shadow-md ${theme==='dark'?" ":" "}`}>
            <img src={pic6} alt="chair" className="w-64 h-64 object-cover mb-4  mx-auto  rounded-lg" />
            <h3 className="text-xl font-semibold">Camping Chair</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className={`product-card p-4  bg-white rounded-lg shadow-md ${theme==='dark'?" ":" "}`}>
            <img src={pic7} alt="table" className="w-80 h-64 object-cover mb-4  mx-auto  rounded-lg" />
            <h3 className="text-xl font-semibold">Folding Camping Table</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className={`product-card p-4  bg-white rounded-lg shadow-md ${theme==='dark'?" ":" "}`}>
            <img src={pic8} alt="stove" className="w-96 h-64 object-cover mb-4  mx-auto  rounded-lg" />
            <h3 className="text-xl font-semibold">Camping Stove</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className={`product-card p-4  bg-white rounded-lg shadow-md ${theme==='dark'?" ":" "}`}>
            <img src={pic9} alt="pot" className="w-64 h-64 object-cover mb-4  mx-auto  rounded-lg" />
            <h3 className="text-xl font-semibold">Camping Pot</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className={`product-card p-4 px-4 pt-28 pb-4   bg-white rounded-lg shadow-md ${theme==='dark'?" ":" "}`}>
            <img src={pic10} alt="torch" className="w-72 h-40 object-cover mb-4  mx-auto  rounded-lg" />
            <h3 className="text-xl font-semibold">Compact LED Torch</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className={`product-card bg-white px-4 py-1 rounded-lg shadow-md ${theme==='dark'?" ":" "}`}>
            <img src={pic11} alt="kit" className="w-64 h-72  object-cover mb-2 mx-auto rounded-lg" />
