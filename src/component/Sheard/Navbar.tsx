  ...
  return (
    <header
      className={`fixed top-0 left-0 z-10 w-full p-4 flex justify-between items-center shadow-xl ${
        theme === "dark"
          ? "bg-gray-900  hover:text-violet-400"
          : "bg-white "
      }`}
    >
      ...
      <div className="space-x-6 items-center hidden lg:flex">
        <nav
          className={`flex space-x-6 text-xl font-semibold ${
            theme === "light" ? "text-blue-800" : "text-sky-300"
          }`}
        >
          <Link
            to="/"
          ...
          <div className="cursor-pointer" onClick={handleThemeToggle}>
            {theme === "dark" ? (
              ...
              <FaMoon className="transition-colors duration-100 text-blue-800 hover:text-violet-700 text-2xl" />
            )}
          </div>
        </nav>
      </div>
      ...
      <div
        className={`mt-20 ${
          ...
          theme === "dark" ? "bg-gray-800 text-white" : "bg-white text-blue-800"
        } px-8 pb-6 pt-4 transition-transform duration-200 ease-in-out rounded-r-xl shadow-xl`}
      >
        <nav className="">
          <ul
        ...
        >
          {theme === "dark" ? (
            ...
            <FaMoon className="text-blue-800 hover:text-violet-700" />
          )}
        </div>
      </div>
    </header>
